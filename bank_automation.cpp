...
void addnewrecord();void viewrecord();
void updaterecord();
void read();
int get_acctno();
void display();
...
gets(person.state);
cout<<endl<<"Enter pin : ";gets(person.pincode);
...
cout<<"Your Balance is not sufficient to 
debit this amount";
 }
 else
 {
...
fstream f5;
account t5,t05;
int timeperiod, j=0;float interest;
t05.read();
...
int irep;
l:clrscr();
cout<<"\nDo you want to change the USERNAME or PASSWORD (y/n) : ";cin>>crep;
if(crep=='y' || crep=='Y')
{
ofstream of;
